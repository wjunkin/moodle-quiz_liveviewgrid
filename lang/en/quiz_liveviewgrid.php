...
$string['clickhidekey'] = 'Click to hide the color key/legend for the grades.';
$string['clickhideanswer'] = 'Click to hide correct answer';
$string['clickshowkey'] = 'Click to show the color key/legend for the grades.';
...
$string['clickforrainbow'] = 'Click to change grading colors to rainbow colors';
...
$string['hoverforinfo'] = 'Hover for information';
