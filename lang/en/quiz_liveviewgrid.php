...
/**
 * Strings for component 'quiz_liveviewgrid', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['colorindicategrades'] = ' the color indicating the grades students would receive if the question were graded.';
$string['colorindicategrade'] = ' for the color to indicate grades.';
$string['correctanswer'] = ' the correct answer to this question.';
...
$string['orexpanded'] = ' or expanded ';
$string['orhide'] = ' or hide ';
$string['orlastname'] = ' or last name ';
$string['orrainbow'] = " or 'rainbow' colors ";
...
$string['studentsnames'] = " the the students' names.";
$string['submitoptionchanges'] = 'Submit changes to options.';
$string['thecolorkey'] = ' the color key/legend for the grades.';
$string['userag'] = 'Use RAG colors ';
