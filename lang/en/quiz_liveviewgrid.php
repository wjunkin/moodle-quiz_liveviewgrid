...
$string['colorindicategrades'] = 'Show color indicating the grades students would receive if the question were graded';
$string['colorindicategrade'] = 'Use RAG (Red, Amber, Green) not Rainbow colors to indicate grades';
