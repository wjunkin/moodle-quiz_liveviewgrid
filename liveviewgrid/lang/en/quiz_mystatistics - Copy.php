...
/**
 * Strings for component 'quiz_mystatistics', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   quiz_mystatistics
...
$string['backtoquizreport'] = 'Back to main mystatistics report page.';
$string['calculatefrom'] = 'Calculate mystatistics from';
$string['calculatingallstats'] = 'Calculating mystatistics for quiz, questions and analysing response data';
...
$string['errormystatisticsquestions'] = 'Error fetching data to calculate mystatistics for question grades';
...
$string['reportsettings'] = 'mystatistics calculation settings';
...
$string['mystatistics'] = 'mystatistics';
$string['mystatistics:componentname'] = 'Quiz mystatistics report';
$string['mystatisticsreport'] = 'mystatistics report';
$string['mystatisticsreportgraph'] = 'mystatistics for question positions';
$string['mystatistics:view'] = 'View mystatistics report';
$string['statsfor'] = 'Quiz mystatistics (for {$a})';
